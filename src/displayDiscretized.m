...
FV.vertices(VertexIndex + 1:VertexIndex + 8, :) = [(ExternalIndexes(i, 1) - 1) + 0.5 + [0 voxel_size(1) voxel_size(1) 0 0 voxel_size(1) voxel_size(1) 0]; ...
    (ExternalIndexes(i, 2) - 1) + 0.5 + [0 0 0 0 voxel_size(2) voxel_size(2) voxel_size(2) voxel_size(2)]; ...
    (ExternalIndexes(i, 3) - 1) + 0.5 + [0 0 voxel_size(3) voxel_size(3) 0 0 voxel_size(3) voxel_size(3)]]';
